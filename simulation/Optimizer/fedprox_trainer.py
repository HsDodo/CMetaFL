...
class FedProxTrainer(object):
    ...
    def _local_test_on_all_clients(self, round_idx):
        ...
        if self.args.enable_wandb:
            wandb.log({"Train/Acc (global)": train_acc, "round": round_idx})
            wandb.log({"Train/Loss (global)": train_loss, "round": round_idx})
        ...
        if self.args.enable_wandb:
            wandb.log({"Test/Acc (global)": test_acc, "round": round_idx})
            wandb.log({"Test/Loss (global)": test_loss, "round": round_idx})
